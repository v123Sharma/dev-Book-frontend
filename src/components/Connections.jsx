...
const Connections = () => {
    ...
    const fecthMyConnections= async()=>{
     try{
  ...
  if(connections.length==0) return <h1 className='flex justify-center my-20'>No Connection Found..!</h1>;
  
  
  return (
    <div className='text-center my-10'>
     <h1 className="text-bold-black text-3xl"> Connections </h1>
